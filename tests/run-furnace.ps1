...
$sources = @(Get-ChildItem -LiteralPath $PSScriptRoot -Recurse -Filter '*.java' | Where-Object { $_.Name -notin @('FeatureRegression.java','MoveLevelRegression.java') } | ForEach-Object FullName)
